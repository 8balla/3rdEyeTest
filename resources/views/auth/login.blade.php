...
<div class="container">
    <div class="row justify-content-center">
        ...
        <center>
        <h5 class="mt-5 btn-link" style="text-decoration: none;">
            ADMIN LOGIN: r3d3@theforce.com | welovespace!
        </h5>
        <h5 class="mt-2 btn-link" style="text-decoration: none;">
            USER LOGIN: <a class="btn-link" href="{{ route('register') }}">create a user account</a>
        </h5>
        </center>
    </div>
    @endsection